...
class LanguageController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            $translations = \File::json(base_path('Modules/Language/Resources/json/languages.json'));
    ...
    public function destroy(Language $language)
    {
        try {
            ...
            LanguageData::where('code', $language->code)
                ->first()
                ->delete();
    ...
    public function syncLanguage(Language $language)
    {
        try {
            ...
            $en_translations = \File::json(resource_path('lang/en.json'));

            // Sync Language Translations
            $lang_translations = \File::json(resource_path("resources/lang/{$language->code}.json"));
