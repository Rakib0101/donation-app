    ...
    function setLocationCurrency()
    {
        ...
        if ($ip && $ip != '127.0.0.1') {
            ...
            if (! session()->has('current_lang')) {
                $country_language_currency = \File::json(resource_path('backend/dummy-data/country_currency_language.json'));
...
if (! function_exists('loadActiveCountries')) {
    ...
    {
        return Cache::remember('active_countries', now()->addDay(30), function () {
...
if (! function_exists('loadAllCurrencies')) {
    ...
    {
        return Cache::remember('currencies', now()->addDay(30), function () {
            return Currency::all();
        });
    }
}
...
if (! function_exists('loadSystemCurrency')) {
    ...
    {
        return Cache::remember('systemCurrency', now()->addDay(30), function () {
...
if (! function_exists('loadSystemLanguageCode')) {
    ...
    {
        return Cache::remember('systemLanguageCode', now()->addDay(30), function () {
...
if (! function_exists('characterLimit')) {
    function charLimit($string, $limit = 25, $end = '...')
    {
