...
class PaymentController extends Controller
{
    ...
    public function sslcommerzUpdate(Request $request)
    {
        ...
        try {
            checkSetConfig('templatecookie.ssl_id', $request->store_id);
            checkSetConfig('templatecookie.ssl_pass', $request->store_password);
            checkSetConfig('templatecookie.ssl_active', $request->ssl_commerz ? true : false);
            checkSetConfig('templatecookie.ssl_mode', $request->ssl_live_mode ? 'live' : 'sandbox');
