<div class="relative inline-flex" x-data="{ notiPanel: false }" @click.outside="notiPanel = false">
    ...
    <!-- Dropdown menu -->
    <div class="absolute z-50 right-0 top-full w-full min-w-[240px] md:min-w-[536px]" x-show="notiPanel" x-cloak
        x-transition>
        <div class="py-6 bg-white rounded-md border border-gray-50 shadow-gray-base-1 ">
            <div class="flex flex-wrap gap-2 justify-between items-center sm:px-6 px-3">
                <h4 class="text-gray-900 body-xl-600">{{__('notification')}}</h4>
                <button
                    ...
                    <a href="#"
                        ...
                        <div>
                            <p class="body-base-600 text-gray-500 sm:line-clamp-2 line-clamp-1"><strong
                                    class="text-gray-900">"MD Khalil"</strong>{{ __('is_a_great_match_for_your') }}
                            <strong class="text-gray-900">{{ __('software_engineer') }}</strong> role.
