...
@section('main')
    <section class="py-[1.75rem]">
        <div class="container flex flex-wrap md:flex-nowrap relative gap-[1.5rem]" x-data="{showSidebar: false}">
            <aside
                class="rounded-xl bg-gray-white shadow-gray-base-1 border border-gray-100 py-[1.25rem] min-w-[26.5rem] space-y-4 h-[60.25rem] overflow-y-auto">
            ...
            <div
                class="rounded-xl bg-gray-white shadow-gray-base-1 border border-gray-100  min-w-[26.5rem] flex flex-col gap-[1.5rem] overflow-hidden w-full">
                {{-- chat header --}}
                <div
