...
@section('content')
    <div class="container">
        <div class="max-w-[984px] min-h-screen mx-auto">
            <x-frontend.account-setup.steps company="complete" detail_info="complete" social_media="active"
                contact="inactive" />
            <div class="py-6">
                <div class="flex-1 space-y-8">
                    <h1 class="heading-05 text-gray-900">Social Media</h1>
                    <form action="#" class="space-y-4" x-init x-data="dynamicInput">
                            ...
                            <div class="space-y-[8px]">
                                ...
                                <div class="flex items-center gap-2">
                                    <div
                                        ...
                                        <div class="w-full">
                                            <input type="text" placeholder="Link/URL" :value="field.link"
                                                x-ref="fieldInput" x-init="field.autofocus && $refs.fieldInput.focus()"
