                ...
                <div class="card-header">
                    <div class="d-flex flex-wrap justify-content-between">
                        ...
                        <div class="d-flex flex-column flex-md-row">
                            ...
                            <a href="{{ route('job.create') }}" class="btn mx-md-1 my-1 my-md-0 bg-primary"><i class="fas fa-plus mr-1"></i>
                                {{ __('create') }}
                            </a>
                            <button data-toggle="modal" data-target="#bulk_import_modal" class="btn mx-md-1 my-1 my-md-0 bg-info"><i
                                            ...
                                            <tr>
                                                ...
                                                <td tabindex="0">
                                                    ...
                                                    @if ($job->deadline <= $formattedDateTime)
                                                        ...
                                                        <p class=" text-danger mt-2" > <small>{{ __('deadline_expired') }}</small></p>
                                                    @else
                                                        {{ date('j F, Y', strtotime($job->deadline)) }}
                                                    @endif
                                                </td>
                                                                ...
                                                                <form
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <label
                                                                            ...
                                                                            data-toggle="tooltip" title="{{__('expired_status_depend_on_deadline')}}" for="status_input_unpublish_{{ $job->id }}">{{ __('expired') }}</label>
                                                                    </div>
                                                                </form>
                                                            @endif
                                                        </div>
                                                ...
                                                <td>
                                                    ...
                                                    <a target="_blank" data-toggle="tooltip" data-placement="top"
                                                        ...
                                                        href="{{ route('website.job.jobDetails', $job->slug) }}"
                                                        class="btn ll-mr-4 ll-p-0">
                                                        <x-svg.table-link />
                                                    </a>
                                                    @if (userCan('job.update'))
