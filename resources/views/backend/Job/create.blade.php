                ...
                <div class="col-md-6">
                            ...
                            <div class="row" id="company-input-container">
                                ...
                                <div class="col-sm-12 form-group hidden" id="company_name_container">
                                    ...
                                    <input id="company_name" type="text" name="company_name"
                                        placeholder="{{ __('company_name') }}" class="form-control  @error('company_name') is-invalid @enderror"
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer location_footer d-none">
                            <span>
                                <img src="{{ asset('frontend/assets/images/loader.gif') }}" alt=""
                            ...
                            <div class="row form-group">
                                <div class="col-md-6">
                                    ...
                                    <select id="education" name="education"
                                        class="form-control select2bs4 @error('education') is-invalid @enderror" required>
