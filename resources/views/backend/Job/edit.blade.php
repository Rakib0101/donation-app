                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group" id="company-input-container">
                                    <div class="col-sm-6 form-group {{ !$job->company_id ? 'hidden' : ''  }}" id="company-input-select">
                                    ...
                                    <div class="col-md-6 form-group {{ $job->company_id ? 'hidden' : ''  }}" id="company_name_container">
                                        <label for="company_name"> :required="true"
                                            {{__('company_name')}}
                                            <span class="text-red font-weight-bold ">*</span></label>
                                        <input id="company_name" type="text" name="company_name" placeholder="Company name" class="form-control @error('company_name') is-invalid @enderror"
                                        ...
                                        <div class="form-check" style="margin-top: 38px">
                                            <div class="icheck-success d-inline">
                                                <input
                                                    ...
                                                    {{ $job->company_id ? '' : 'checked'  }}
                                                    {{--                                                {{ old('is_just_name')  ? 'checked':'' }}--}}
                                                    id="just_name">
                                                <label class="form-check-label mr-5" for="just_name">{{__('create_a_job_without_comapany_account')}}</label>
                                            </div>
                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="{{ $map == 'leaflet' ? '' : 'd-none' }}">
                                <input type="text" autocomplete="off" id="leaflet_search"
                                    ...
                                    value="{{ $job->exact_location ? $job->exact_location : $job->full_address }}" /> <br>
                        ...
                        @php
                            ...
                            $job_exact_location = $job->exact_location;
                        @endphp
                        <div class="card-footer">
                            ...
                            <div class="location_secion">
                                {{ __('country') }}: <span class="location_country">{{ $job_country ?: $session_country }}</span> <br>
                                {{ __('full_address') }}: <span class="location_full_address">{{ $job_exact_location ?: $session_exact_location  }}</span>
                            </div>
                        </div>
                    </div>
                </div>
