            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('settings.payment.update') }}" method="POST"
                    ...
                    <div class="form-group row">
                        <x-forms.label name="live_mode" class="col-sm-3" />
                        <div class="col-sm-9">
                            <input {{ config('templatecookie.ssl_mode') == 'live' ? 'checked' : '' }} type="checkbox"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ config('templatecookie.ssl_id') }}" name="store_id" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input
                                value="{{ config('templatecookie.ssl_pass') }}" name="store_password" type="text"
                    ...
                    <div class="form-group row">
                        <x-forms.label name="status" class="col-sm-3" />
                        <div class="col-sm-9">
                            <input {{ config('templatecookie.ssl_active') ? 'checked' : '' }} type="checkbox"
