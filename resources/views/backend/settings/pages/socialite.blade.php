                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.social.login.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('services.linkedin.client_id') }}" name="linkedin_client_id"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ config('services.linkedin.client_secret') }}" name="linkedin_client_secret"
                                    type="text"
                        ...
                        <div class="form-group row">
                            <x-forms.label name="status" class="col-sm-5" />
                            <div class="col-sm-7">
                                <input {{ config('services.linkedin.active') ? 'checked' : '' }} type="checkbox"
