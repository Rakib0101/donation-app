                ...
                <form class="form-horizontal" action="{{ route('settings.pusher.update') }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ old('pusher_app_id', config('templatecookie.pusher_app_id')) }}" name="pusher_app_id"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ old('pusher_app_key', config('templatecookie.pusher_app_key')) }}" name="pusher_app_key"
                                    type="text" class="form-control @error('pusher_app_key') is-invalid @enderror"
                                    autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ old('pusher_app_secret', config('templatecookie.pusher_app_secret')) }}" name="pusher_app_secret"
                                    type="text" class="form-control @error('pusher_app_secret') is-invalid @enderror"
                                    autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ old('pusher_host', config('templatecookie.pusher_host')) }}" name="pusher_host"
                                    type="text" class="form-control @error('pusher_host') is-invalid @enderror"
                                    autocomplete="off">
                                @error('pusher_host')
                                    <span class="invalid-feedback" role="alert"><span>{{ $message }}</span></span>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ old('pusher_port', config('templatecookie.pusher_port')) }}" name="pusher_port"
                                    type="text" class="form-control @error('pusher_port') is-invalid @enderror"
                                    autocomplete="off">
                                @error('pusher_port')
                                    <span class="invalid-feedback" role="alert"><span>{{ $message }}</span></span>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ old('pusher_schema', config('templatecookie.pusher_schema')) }}" name="pusher_schema"
                                    type="text" class="form-control @error('pusher_schema') is-invalid @enderror"
                                    autocomplete="off">
                                @error('pusher_schema')
                                    <span class="invalid-feedback" role="alert"><span>{{ $message }}</span></span>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input value="{{ old('pusher_app_cluster', config('templatecookie.pusher_app_cluster')) }}" name="pusher_app_cluster"
                ...
                <form class="form-horizontal" action="{{ route('settings.analytics.update') }}" method="POST"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input {{ old('is_analytics_active') ?? config('templatecookie.google_analytics_status') ? 'checked' : '' }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4 @error('code') is-invalid @enderror" name="code"
                                        id="default_language">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="currency" class="custom-select select2bs4 mr-sm-2" id="inlineFormCustomSelect">
                            ...
                            <div class="col-sm-8 {{ $setting->app_country_type == 'multiple_base' ? '' : 'd-none' }}"
                                ...
                                @php
                                    $active_countries = $countries
                                        ...
                                        ->toArray();
                                @endphp
                                <select name="multiple_country[]" class="custom-select mr-sm-2 multiple_country" id=""
                                    multiple>
