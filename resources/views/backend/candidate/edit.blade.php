                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="{{ $map == 'leaflet' ? '' : 'd-none' }}">
                                    <input type="text" autocomplete="off" id="leaflet_search"
                                        placeholder="{{ __('enter_city_name') }}"  value="{{ $candidate->exact_location ? $candidate->exact_location : $candidate->full_address }}" class="form-control" /> <br>
                            ...
                            <div class="card-footer">
                                ...
                                <div class="location_secion">
                                    {{ __('country') }}: <span class="location_country">{{ $candidate_country ?: $session_country }}</span> <br>
                                    {{ __('full_address') }}: <span class="location_full_address">{{ $candidate_exact_location ?: $session_exact_location  }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
