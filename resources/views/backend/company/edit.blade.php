                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <x-forms.input type="text" name="name" data-show-errors="true" placeholder="{{__('name')}}"
                                    value="{{ old('name', $user->name) }}" />
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <x-forms.label name="username" :required="false"/>
                                    <x-forms.input type="text" name="username" placeholder="{{__('username')}}"
                                        value="{{ old('username', $user->username) }}" />
                                </div>
                                <div class="form-group col-sm-6">
                                    <x-forms.label name="email" />
                                    <x-forms.input type="email" name="email" placeholder="{{__('email')}}"
                            ...
                            <div class="form-group">
                                ...
                                <x-forms.input type="password" name="password" placeholder="{{__('password')}}" />
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="google-map-div" class="{{ $map == 'google-map' ? '' : 'd-none' }}">
                                <input id="searchInput" class="mapClass" type="text" placeholder="{{__('enter_a_location')}}">
                                <div class="map mymap" id="google-map"></div>
                            </div>
                            <div class="{{ $map == 'leaflet' ? '' : 'd-none' }}">
                                <input type="text" autocomplete="off" id="leaflet_search" placeholder="{{ __('enter_city_name') }}" class="form-control" value="{{ $company->exact_location ? $company->exact_location: $company->full_address }}"/> <br>
                        ...
                        @php
                            ...
                            $company_exact_location = $company->exact_location;
                        @endphp
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-xl-4">
                                    ...
                                    <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2 recommended-img-note mb-0">Recommended Image Size: 68x68</p>
                                </div>
                                <div class="form-group col-xl-8">
                                    ...
                                    <p class="tw-text-gray-500 tw-text-xs tw-text-left mt-2 recommended-img-note mb-0">Recommended Image Size: 1920x312</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea id="image_ckeditor" rows="8" name="bio" placeholder="{{ __('bio') }}" class="form-control">{{ old('bio', $company->bio) }}</textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <x-forms.label name="vision" :required="false" />
                                    <textarea id="image_ckeditor_2" rows="8" name="vision" placeholder="{{ __('vision') }}" class="form-control">{{ old('vision', $company->vision) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
