                            ...
                            <div class="ll-flex-item">
                                <div class="company-details__right">
                                    ...
                                    <div class="three">
                                        ...
                                        <div class="d-flex">
                                            <x-svg.details-envelop stroke="var(--primary-500)" fill="var(--primary-500)"/>
                                            <div>
                                        ...
                                        @endif
                                            <div class="d-flex">
                                                <svg
                                                    width="24" height="25"
                                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--primary-500)" fill="var(--primary-500)" class="w-6 h-6">
